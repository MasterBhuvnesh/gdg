...
const faqData: FAQItem[] = [
  {
    ...
    answer:
      "GDG on Campus RBU is a student-led community that helps students explore and learn Google technologies through workshops, hackathons, and tech talks.",
  },
  {
    id: "who-can-join",
    question: "Who can join GDG on Campus RBU?",
    answer:
      "Any student at RBU interested in tech—whether a beginner or an expert—can join us.",
  },
  {
    id: "events",
    question: "What happens at GDG events?",
    answer:
      "We host workshops, hackathons, tech talks, and hands-on coding sessions to help students learn and collaborate.",
  },
  {
    id: "is-free",
    question: "Is joining GDG on Campus RBU free?",
    answer:
      "Yes! There are no membership fees—our events and resources are completely free.",
  },
  {
    id: "how-to-join",
    question: "How can I join GDG on Campus RBU?",
    answer:
      "You can join by following our social media for updates and attending our upcoming events at RBU.",
  },
];
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-base md:text-lg text-gray-400 flex text-center">
            Everything you need to know about GDG On Campus RBU . Can&apos;t
            find the answer you are looking for? Feel free to contact our
            management team.
          </p>
        </div>
